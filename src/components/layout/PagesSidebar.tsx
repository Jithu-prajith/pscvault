...
import { Plus, FolderPlus, FilePlus, ChevronRight, ChevronDown, Star, Folder, FileText, Trash2, X } from 'lucide-react';
...
export const PagesSidebar: React.FC = () => {
  ...
  const pagesSidebarOpen = useUIStore((s) => s.pagesSidebarOpen);
  ...
  if (!pagesSidebarOpen) return null;
  ...
  return (
    <>
      ...
      <aside className="fixed md:static inset-y-0 left-0 top-14 w-72 sm:w-64 bg-slate-900/95 dark:bg-slate-950/95 md:bg-slate-900/60 md:dark:bg-slate-950/80 border-r border-slate-200 dark:border-slate-800 flex flex-col h-[calc(100vh-3.5rem)] shrink-0 select-none z-40 shadow-2xl md:shadow-none animate-in slide-in-from-left">
        ...
        <div className="p-3 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between gap-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <button
              onClick={togglePagesSidebar}
              className="md:hidden p-1 text-slate-400 hover:text-white rounded-lg ml-1"
            >
              <X className="w-4 h-4" />
            </button>
          </div>
                          ...
                          topics.map((top) => {
                            ...
                            return (
                              <button
                                ...
                                className={`flex items-center gap-2 p-2 sm:p-1.5 rounded-lg text-left text-xs transition-colors group/item ${
                                  isTopActive
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className="p-1 opacity-100 sm:opacity-0 group-hover/item:opacity-100 text-slate-400 hover:text-red-400 hover:bg-slate-800 rounded transition-opacity"
                      ...
                      <div className="flex items-center justify-between gap-1">
                        ...
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="p-0.5 opacity-100 sm:opacity-0 group-hover:opacity-100 text-slate-400 hover:text-red-400 rounded"
                            title="Move to Trash"
                          >
                            <Trash2 className="w-3 h-3" />
                          </button>
