  ...
  return (
    <>
      ...
      <div
        ...
        className="lg:hidden fixed inset-0 z-30 bg-slate-950/60 backdrop-blur-xs animate-in fade-in"
      />

      <aside className="fixed lg:static inset-y-0 right-0 top-14 w-80 lg:w-72 bg-slate-900/95 dark:bg-slate-950/95 lg:bg-slate-900/40 lg:dark:bg-slate-950/90 border-l border-slate-200 dark:border-slate-800 flex flex-col h-[calc(100vh-3.5rem)] shrink-0 select-none z-40 overflow-y-auto p-4 gap-6 text-xs shadow-2xl lg:shadow-none animate-in slide-in-from-right">
